...
Add your computational results here. See Table~\ref{tab:mascots} for how to include a table in your document. See Figure~\ref{fig:car-speed-dist-1} for how to include figures in your document.
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{figures/Cars-speed_dist-1.jpeg}
    \caption{Here is a picture of Dubs \cite{webeck_2018}. Dubs did not swallow a marble.}
    \label{fig:car-speed-dist-1}
\end{figure}
...
\begin{listing}[h] % h (here if you possibly can) H (right here), t (top), b (bottom)
